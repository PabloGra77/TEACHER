...
st.markdown(f"""
    ...
    /* ELIMINA ESTILOS DEL BOTÓN STREAMLIT */
...
# --- VISTAS DEL PANEL ADMIN (Funciones sin cambios) ---
def profile_editor():
...
def presentation_manager():
    ...
    st.info("Sube tus archivos PDF o PPTX.")
    ...
    st.markdown("---"); st.subheader("🧹 Gestionar Botones Existentes")
